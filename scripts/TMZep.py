...
def train_model(train_fea, train_label):
    parameters = {'max_depth':range(3,8),'n_estimators': np.arange(10,110,10)}
    clf = GridSearchCV(XGBC(learning_rate=0.03,subsample=0.25,random_state=30), parameters, cv=5, scoring='roc_auc')
